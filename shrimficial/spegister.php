...
?> <nav>
    ...
    <a href = register.php><img src = "eng.png" class = "eng1"></a>
    <h2>Shrimstagram</h2>
    </div>
    </div>
</nav>
...
<button onclick="document.getElementById('id01').style.display='block'" class = "signup" style="width:auto;">Registro Aquí!</button>
...
<div class="card1">
  ...
  <div class="container1">
    ...
    <p3>Expert at asking Kais for help<br> Relies on partners way too much<br> Has many issues<br><br> Loves Shrimstagram tho</p3> 
  </div>
</div>
...
<div class="card2">
  ...
  <div class="container2">
    ...
    <p3>Hola, soy los creadores de este glorioso sitio web! Se necesitó mucha sangre, sudor y lágrimas, así que realmente, realmente espero que les guste nuestro sitio web!!</p3> 
  </div>
</div>
</form>
