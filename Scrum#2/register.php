...
<nav>
    ...
    <img src = "logo.png">
    <a href = register.php><img src = "french.png" class = "french"></a>
    <h2>InstaShrim</h2>
    </div>
    </div>
</nav>
...
<p>Hi, welcome to our groovy new social media site!<p>


<button onclick="document.getElementById('id01').style.display='block'" class = "signbutt" style="width:auto;">Sign Up Here!</button>
<!--
<div class = "ca1">
<img src = "stars.png">
...
<div id="id01" class="modal">
  ...
  <h6>
    <p>Name: <input type="text" name="name" placeholder = "John Appleseed"> <br>
    E-mail: <input type="text" name="email" placeholder = "john.appleseed@instashrim.com"><br>
    Username: <input type="text" name="username" placeholder = "@jappleseed" value="" /> 
    Password: <input type="password" name="password" placeholder = "johnlovesinstashrim" value="" />  
