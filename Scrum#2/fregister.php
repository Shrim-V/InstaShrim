...
<p>Bonjour, et bienvenue dans notre nouveau site de réseaux sociaux!<p>


<button onclick="document.getElementById('id01').style.display='block'" class = "signbutt" style="width:auto;">Inscrivez-Vous Ici!</button>
<!--
<div class = "ca1">
<img src = "stars.png">
...
<div id="id01" class="modal">
  ...
  <h6>
    <p>Nom: <input type="text" name="name" placeholder = "John Appleseed"> <br>
    Courriel: <input type="text" name="email" placeholder = "john.appleseed@instashrim.com"><br>
    Nom d'Utilisateur: <input type="text" name="username" placeholder = "@jappleseed" value="" /> 
    Mot de Passe: <input type="password" name="password" placeholder = "johnlovesinstashrim" value="" />  
