...
?> <nav>
    ...
    <a href = register.php><img src = "eng.png" class = "eng"></a>
...
<button onclick="document.getElementById('id01').style.display='block'" class = "frignup" style="width:auto;">Registre Içi!</button>
...
<div class="card2">
  ...
  <div class="container2">
    ...
    <p3>Bonjour, je suis un créateur de ce glorieux site! Il a fallu beaucoup de sang, de sueurs et de larmes, alors j'ai vraiment, j'espère vraiment que vous aimez notre site!</p3> 
  </div>
</div>
</form>
