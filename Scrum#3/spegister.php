...
.container2 {
    ...
    position: absolute; top: -30px; left: 470px;
...
.ca3{
    ...
    position: absolute; left: 1160px; top: 10px;
}.uk{
    position: absolute; left: 1060px; top: 10px;
}
</style>
</head>
<body>
...
<nav>
    ...
    <a href = register.php><img src = "uk.png" class = "uk"></a>
    <h2>InstaShrim</h2>
    </div>
    </div>
</nav>
...
<p>Hola, bienvenido a nuestro nuevo y maravilloso sitio de medios sociales!<p>


<button onclick="document.getElementById('id01').style.display='block'" class = "signbutt" style="width:auto;">Registrate Aquí!</button>
<!--
<div class = "ca1">
<img src = "stars.png">
...
<div id="id01" class="modal">
  ...
  <h6>
    <p>Nombre: <input type="text" name="name" placeholder = "John Appleseed"> <br>
    Correo Electrónico: <input type="text" name="email" placeholder = "john.appleseed@instashrim.com"><br>
    Nombre de Usuario: <input type="text" name="username" placeholder = "@jappleseed" value="" /> 
    Contraseña: <input type="password" name="password" placeholder = "johnlovesinstashrim" value="" />  
...
<div class="card2">
  <img src="anish.jpg" alt = "ansh could not be with us today" >
